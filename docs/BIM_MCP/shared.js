(function () {
  ...
  var PAGE_META = {
    ...
    "reference/skills-index": { title: "Skills 索引（61）", desc: "編排層：何時觸發 / 什麼順序。" },
    "reference/mep-playbook": { title: "機電教戰手冊", desc: "domain/mep-space-demand-matrix 的教學版，三章 + 配套模型導覽。" },
    "reference/tools-index": { title: "Tools 索引", desc: "197 個執行層工具，依用途分八類。" },
    "reference/domain-index": { title: "Domain 索引（83）", desc: "知識層：法規 / SOP / lessons。" },
    ...
    "skills-index": { title: "Skills 索引", desc: "61 個編排層 Skill。" },
    "domain-index": { title: "Domain 索引", desc: "83 個 SOP 知識。" },
