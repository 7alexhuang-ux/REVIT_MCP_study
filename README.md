...
Talk to Revit in plain language. Ask your AI client to *"dimension every wall on this view"* or *"check the curtain-wall elevations"*, and Revit does it — through **193 MCP tools** backed by **83 professional BIM SOPs** (building code, quantity take-off, compliance checks).
...
| Item | Count | Source |
|---|---:|---|
| Runtime MCP tools | 193 | `registerRevitTools()` in `MCP-Server/src/tools/index.ts` |
